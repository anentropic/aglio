(function() {
  var INCLUDE, LEGACY_TEMPLATES, ROOT, benchmark, drafter, errMsg, fs, includeDirective, includeReplace, path, process_stdin,
  ...
  process_stdin = function(processor) {
    var chunks;
